...
const AboutPage = () => {
  const values = [
    ...
    },
    {
      ...
      description: 'Every decision we make is focused on helping teams run delivery networks flawlessly.'
    },
    {
      icon: Globe,
  ...
  const stats = [
    { icon: Users, number: '60K+', label: 'Active Accounts' },
  ...
  const team = [
    ...
    },
    {
      ...
      description: 'Operations expert ensuring smooth rider network management and service quality.',
      avatar: '👩‍🔧'
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              These principles guide everything we do, from product development to operational support.
            </p>
          </div>
      ...
      <section className="py-20 gradient-hero">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto mb-8">
            Join operations teams who rely on Rush Express to keep deliveries on track.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
