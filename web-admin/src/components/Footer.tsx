...
const Footer = () => {
  ...
  const quickLinks = [
    ...
    { path: '/register', label: 'Request Access' },
  ];

  const services = [
    { path: '/admin', label: 'Admin Dashboard' },
    { path: '/login', label: 'Admin Sign In' },
    { path: '/register', label: 'Admin Access' },
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-subtle p-4 rounded-lg border border-border/50">
              ...
              <p className="text-xs text-muted-foreground">
                Need help? Our admin support team is always ready to assist you.
              </p>
            </div>
          </div>
        </div>
