...
const AboutPage = () => {
  const values = [
    ...
    },
    {
      icon: Heart,
      title: 'Rider First',
      description: 'Every decision we make is focused on creating the best experience for our riders.'
    },
    {
      icon: Globe,
  ...
  const team = [
    ...
    },
    {
      ...
      description: 'Operations expert ensuring smooth rider network management and rider satisfaction.',
      avatar: '👩‍🔧'
    },
  ];
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild variant="hero" size="lg">
                <Link to="/register">Join as a Rider</Link>
              </Button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              These principles guide everything we do, from product development to rider support.
            </p>
          </div>
      ...
      <section className="py-20 gradient-hero">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto mb-8">
            Join a trusted delivery network and start earning with Rush Express.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
